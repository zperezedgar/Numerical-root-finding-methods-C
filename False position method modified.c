...
double Emin=10E-9, Eact, Xizq, Xder, Xant, Xact, a, b, Error, c, d, Xact1, z;

int main(int argc, char *argv[]) 
{
	printf("\nMETODO DE BISECCION-PROPORCIONES PARA CALCULAR RAICES\n");   //mensaje de bienvenida, metodo a usar y funcion a evaluar
	printf("Funcion predefinida: (e^-x)-x=0\n");     //funcion f(x) (INTRODUCIR)          
